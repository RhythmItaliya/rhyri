                ...
                <div className="flex border-b border-black">
                    <div className="flex-1 border-r border-black p-2">
                        <p className="text-sm text-gray-600 uppercase flex justify-between px-2">
                            ...
                            <span className="font-semibold text-black text-right">{company.companyGSTNumber}</span>
                        </p>
                    </div>
                    <div className="flex-1 border-r border-black p-2">
            ...
            <div className="flex">
                ...
                <div className="w-1/2 border-b border-black">
                    <table className="w-full text-xs">
                        <thead>
                            <tr>
                                <th colSpan={2} className="text-md text-center border-b text-gray-600 py-2 border-black">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="uppercase font-semibold text-right pr-2">{customer.clientName}</td>
                            </tr>
                            <tr>
                                <td className="text-gray-600 pr-4 p-1 text-left pl-2 uppercase">{fieldNames.gstin}</td>
                                <td className="uppercase font-semibold text-right pr-2">{customer.clientGSTNumber}</td>
                            </tr>
                            <tr>
                                <td className="text-gray-600 pr-4 p-1 text-left pl-2 uppercase">{fieldNames.customerTel}</td>
                                <td className="uppercase font-semibold text-right pr-2">{customer.clientTelephone}</td>
                            </tr>
                            <tr>
                                <td className="text-gray-600 pr-4 p-1 text-left pl-2 uppercase">{fieldNames.customerEmail}</td>
                                <td className="lowercase font-semibold text-right pr-2">{customer.clientEmail}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table className="w-full text-xs">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className='uppercase font-semibold text-right pr-2'>{invoice.invoiceCustomNumber}</td>
                            </tr>
                            <tr>
