            ...
            <CardContent className="space-y-8 p-8">
              <div className="flex items-start flex-col sm:flex-row gap-4 justify-between">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted">{invoice.clientCity}</p>
                  <p className="text-sm text-muted">{invoice.clientPostCode}</p>
                  <p className="text-sm text-muted">{invoice.clientCountry}</p>
                </div>
              </div>
              ...
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-3">
                ...
                <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <p className="text-muted">{invoice.clientAddress}</p>
