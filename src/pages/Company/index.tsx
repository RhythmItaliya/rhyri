                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>{company.companyTelephone}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>{company.companyPostCode}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>State</TableCell>
                                            <TableCell>{company.companyState}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>GST Number</TableCell>
                                            <TableCell>{company.companyGSTNumber}</TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            </div>
