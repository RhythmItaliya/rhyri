...
const ClientPopup: React.FC<ClientPopupProps> = ({ onSelect, onClose }) => {
    ...
    }, [pagination.pageIndex, allClients, nameFilter, emailFilter, phoneFilter]);

    const updateClientsForCurrentPage = (clientsList: Client[]) => {
        const filteredClients = clientsList.filter(client =>
            client.clientName.toLowerCase().includes(nameFilter.toLowerCase()) &&
            client.clientEmail.toLowerCase().includes(emailFilter.toLowerCase()) &&
            (client.clientTelephone?.toLowerCase().includes(phoneFilter.toLowerCase()) || '')
        );
